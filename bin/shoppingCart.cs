// Dafny program shoppingCart.dfy compiled into C#
...
// Command-line arguments: build --output bin\shoppingCart c:\Users\grees\OneDrive\Documents\DafnyShop\shoppingCart.dfy
// shoppingCart.dfy
...
method AddItem(cart: ShoppingCart, user: UserId, item: ItemId, price: Price, quantity: Quantity)
  ...
  decreases cart, user, item, price, quantity
{
  if user in cart {
...
function AddOrUpdateItem(items: seq<CartItem>, item: ItemId, price: Price, quantity: Quantity): seq<CartItem>
  ...
  decreases items, item, price, quantity
{
  if |items| == 0 then
...
method ChangeQuantity(cart: ShoppingCart, user: UserId, item: ItemId, newQuantity: Quantity)
  ...
  decreases cart, user, item, newQuantity
{
  if user in cart {
...
function UpdateQuantity(items: seq<CartItem>, item: ItemId, newQuantity: Quantity): seq<CartItem>
  ...
  decreases items, item, newQuantity
{
  if |items| == 0 then
    []
  else if items[0].item == item then
...
namespace _module {
  ...
  public partial class __default {
    public static Dafny.IMap<_IUserId,Dafny.ISequence<_ICartItem>> AddItem(Dafny.IMap<_IUserId,Dafny.ISequence<_ICartItem>> cart, _IUserId user, _IItemId item, Dafny.BigRational price, BigInteger quantity)
    {
      Dafny.IMap<_IUserId,Dafny.ISequence<_ICartItem>> newCart = Dafny.Map<_IUserId, Dafny.ISequence<_ICartItem>>.Empty;
      if ((cart).Contains(user)) {
        newCart = Dafny.Map<_IUserId, Dafny.ISequence<_ICartItem>>.Update(cart, user, __default.AddOrUpdateItem(Dafny.Map<_IUserId, Dafny.ISequence<_ICartItem>>.Select(cart,user), item, price, quantity));
      } else {
        newCart = Dafny.Map<_IUserId, Dafny.ISequence<_ICartItem>>.Update(cart, user, Dafny.Sequence<_ICartItem>.FromElements(_module.CartItem.create(item, quantity, price)));
      }
      return newCart;
    }
    public static Dafny.ISequence<_ICartItem> AddOrUpdateItem(Dafny.ISequence<_ICartItem> items, _IItemId item, Dafny.BigRational price, BigInteger quantity)
    {
      Dafny.ISequence<_ICartItem> _0___accumulator = Dafny.Sequence<_ICartItem>.FromElements();
    TAIL_CALL_START: ;
      if ((new BigInteger((items).Count)).Sign == 0) {
        return Dafny.Sequence<_ICartItem>.Concat(_0___accumulator, Dafny.Sequence<_ICartItem>.FromElements(_module.CartItem.create(item, quantity, price)));
      } else if (object.Equals(((items).Select(BigInteger.Zero)).dtor_item, item)) {
        return Dafny.Sequence<_ICartItem>.Concat(_0___accumulator, Dafny.Sequence<_ICartItem>.Concat(Dafny.Sequence<_ICartItem>.FromElements(_module.CartItem.create(item, (((items).Select(BigInteger.Zero)).dtor_quantity) + (quantity), price)), (items).Drop(BigInteger.One)));
      } else {
        _0___accumulator = Dafny.Sequence<_ICartItem>.Concat(_0___accumulator, Dafny.Sequence<_ICartItem>.FromElements((items).Select(BigInteger.Zero)));
        Dafny.ISequence<_ICartItem> _in0 = (items).Drop(BigInteger.One);
        _IItemId _in1 = item;
        Dafny.BigRational _in2 = price;
        BigInteger _in3 = quantity;
        items = _in0;
        item = _in1;
        price = _in2;
        quantity = _in3;
    ...
    public static Dafny.IMap<_IUserId,Dafny.ISequence<_ICartItem>> DeleteItem(Dafny.IMap<_IUserId,Dafny.ISequence<_ICartItem>> cart, _IUserId user, _IItemId item)
    {
      Dafny.IMap<_IUserId,Dafny.ISequence<_ICartItem>> newCart = Dafny.Map<_IUserId, Dafny.ISequence<_ICartItem>>.Empty;
      if ((cart).Contains(user)) {
        newCart = Dafny.Map<_IUserId, Dafny.ISequence<_ICartItem>>.Update(cart, user, __default.RemoveItem(Dafny.Map<_IUserId, Dafny.ISequence<_ICartItem>>.Select(cart,user), item));
      } else {
        newCart = cart;
      }
      return newCart;
    }
    public static Dafny.ISequence<_ICartItem> RemoveItem(Dafny.ISequence<_ICartItem> items, _IItemId item)
    {
      Dafny.ISequence<_ICartItem> _0___accumulator = Dafny.Sequence<_ICartItem>.FromElements();
    TAIL_CALL_START: ;
      if ((new BigInteger((items).Count)).Sign == 0) {
        return Dafny.Sequence<_ICartItem>.Concat(_0___accumulator, Dafny.Sequence<_ICartItem>.FromElements());
      } else if (object.Equals(((items).Select(BigInteger.Zero)).dtor_item, item)) {
        return Dafny.Sequence<_ICartItem>.Concat(_0___accumulator, (items).Drop(BigInteger.One));
      } else {
        _0___accumulator = Dafny.Sequence<_ICartItem>.Concat(_0___accumulator, Dafny.Sequence<_ICartItem>.FromElements((items).Select(BigInteger.Zero)));
        Dafny.ISequence<_ICartItem> _in0 = (items).Drop(BigInteger.One);
        _IItemId _in1 = item;
    ...
    public static Dafny.IMap<_IUserId,Dafny.ISequence<_ICartItem>> ChangeQuantity(Dafny.IMap<_IUserId,Dafny.ISequence<_ICartItem>> cart, _IUserId user, _IItemId item, BigInteger newQuantity)
    {
      Dafny.IMap<_IUserId,Dafny.ISequence<_ICartItem>> newCart = Dafny.Map<_IUserId, Dafny.ISequence<_ICartItem>>.Empty;
      if ((cart).Contains(user)) {
        newCart = Dafny.Map<_IUserId, Dafny.ISequence<_ICartItem>>.Update(cart, user, __default.UpdateQuantity(Dafny.Map<_IUserId, Dafny.ISequence<_ICartItem>>.Select(cart,user), item, newQuantity));
      } else {
        newCart = cart;
      }
      return newCart;
    }
    public static Dafny.ISequence<_ICartItem> UpdateQuantity(Dafny.ISequence<_ICartItem> items, _IItemId item, BigInteger newQuantity)
    {
      Dafny.ISequence<_ICartItem> _0___accumulator = Dafny.Sequence<_ICartItem>.FromElements();
    TAIL_CALL_START: ;
      if ((new BigInteger((items).Count)).Sign == 0) {
        ...
        return Dafny.Sequence<_ICartItem>.Concat(_0___accumulator, Dafny.Sequence<_ICartItem>.Concat(Dafny.Sequence<_ICartItem>.FromElements(_module.CartItem.create(item, newQuantity, ((items).Select(BigInteger.Zero)).dtor_price)), (items).Drop(BigInteger.One)));
      } else {
        _0___accumulator = Dafny.Sequence<_ICartItem>.Concat(_0___accumulator, Dafny.Sequence<_ICartItem>.FromElements((items).Select(BigInteger.Zero)));
        Dafny.ISequence<_ICartItem> _in0 = (items).Drop(BigInteger.One);
        _IItemId _in1 = item;
        BigInteger _in2 = newQuantity;
        items = _in0;
        item = _in1;
        newQuantity = _in2;
        goto TAIL_CALL_START;
    ...
    public static Dafny.BigRational TotalCost(Dafny.IMap<_IUserId,Dafny.ISequence<_ICartItem>> cart, _IUserId user)
    {
      Dafny.BigRational total = Dafny.BigRational.ZERO;
      if ((cart).Contains(user)) {
        total = __default.CalculateTotal(Dafny.Map<_IUserId, Dafny.ISequence<_ICartItem>>.Select(cart,user));
      } else {
        total = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
      }
      return total;
    }
    public static Dafny.BigRational CalculateTotal(Dafny.ISequence<_ICartItem> items) {
    ...
    TAIL_CALL_START: ;
      if ((new BigInteger((items).Count)).Sign == 0) {
        ...
        _0___accumulator = (_0___accumulator) + ((((items).Select(BigInteger.Zero)).dtor_price) * (new Dafny.BigRational((((items).Select(BigInteger.Zero)).dtor_quantity), BigInteger.One)));
        Dafny.ISequence<_ICartItem> _in0 = (items).Drop(BigInteger.One);
        items = _in0;
        goto TAIL_CALL_START;
      }
    }
    public static Dafny.ISequence<_ICartItem> Checkout(Dafny.IMap<_IUserId,Dafny.ISequence<_ICartItem>> cart, _IUserId user)
    {
      Dafny.ISequence<_ICartItem> checkoutCart = Dafny.Sequence<_ICartItem>.Empty;
      if ((cart).Contains(user)) {
        checkoutCart = Dafny.Map<_IUserId, Dafny.ISequence<_ICartItem>>.Select(cart,user);
      } else {
        checkoutCart = Dafny.Sequence<_ICartItem>.FromElements();
      }
      return checkoutCart;
    }
    public static _IUserId UserIdWitness { get {
      return _module.UserId.create();
    } }
    public static _IItemId ItemIdWitness { get {
      return _module.ItemId.create();
    } }
  }

  public interface _IUserId {
    bool is_MkUserId { get; }
    _IUserId DowncastClone();
  }
  public class UserId : _IUserId {
    public UserId() {
    }
    public _IUserId DowncastClone() {
      if (this is _IUserId dt) { return dt; }
      return new UserId();
    }
    public override bool Equals(object other) {
      var oth = other as UserId;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "UserId.MkUserId";
      return s;
    }
    private static readonly _IUserId theDefault = create();
    public static _IUserId Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_IUserId> _TYPE = new Dafny.TypeDescriptor<_IUserId>(UserId.Default());
    public static Dafny.TypeDescriptor<_IUserId> _TypeDescriptor() {
      return _TYPE;
    }
    public static _IUserId create() {
      return new UserId();
    }
    public static _IUserId create_MkUserId() {
      return create();
    }
    public bool is_MkUserId { get { return true; } }
    public static System.Collections.Generic.IEnumerable<_IUserId> AllSingletonConstructors {
      get {
        yield return UserId.create();
      }
    }
  }

  public interface _IItemId {
    bool is_MkItemId { get; }
    _IItemId DowncastClone();
  }
  public class ItemId : _IItemId {
    public ItemId() {
    }
    public _IItemId DowncastClone() {
      if (this is _IItemId dt) { return dt; }
      return new ItemId();
    }
    public override bool Equals(object other) {
      var oth = other as ItemId;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "ItemId.MkItemId";
      return s;
    }
    private static readonly _IItemId theDefault = create();
    public static _IItemId Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_IItemId> _TYPE = new Dafny.TypeDescriptor<_IItemId>(ItemId.Default());
    public static Dafny.TypeDescriptor<_IItemId> _TypeDescriptor() {
      return _TYPE;
    }
    public static _IItemId create() {
      return new ItemId();
    }
    public static _IItemId create_MkItemId() {
      return create();
    }
    public bool is_MkItemId { get { return true; } }
    public static System.Collections.Generic.IEnumerable<_IItemId> AllSingletonConstructors {
      get {
        yield return ItemId.create();
      }
    }
  }
  ...
  public partial class Quantity {
    ...
    private static readonly Dafny.TypeDescriptor<BigInteger> _TYPE = new Dafny.TypeDescriptor<BigInteger>(Quantity.Default());
    public static Dafny.TypeDescriptor<BigInteger> _TypeDescriptor() {
      return _TYPE;
    }
    public static bool _Is(BigInteger __source) {
  ...
  public partial class Price {
    private static readonly Dafny.TypeDescriptor<Dafny.BigRational> _TYPE = new Dafny.TypeDescriptor<Dafny.BigRational>(Dafny.BigRational.ZERO);
    public static Dafny.TypeDescriptor<Dafny.BigRational> _TypeDescriptor() {
      return _TYPE;
    }
    public static bool _Is(Dafny.BigRational __source) {
      Dafny.BigRational _1_x = __source;
      return (_1_x) >= (new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One));
    }
  }

  public interface _ICartItem {
    bool is_CartItem { get; }
    _IItemId dtor_item { get; }
    BigInteger dtor_quantity { get; }
    Dafny.BigRational dtor_price { get; }
    _ICartItem DowncastClone();
  }
  public class CartItem : _ICartItem {
    public readonly _IItemId _item;
    public readonly BigInteger _quantity;
    public readonly Dafny.BigRational _price;
    public CartItem(_IItemId item, BigInteger quantity, Dafny.BigRational price) {
      this._item = item;
      this._quantity = quantity;
      this._price = price;
    }
    public _ICartItem DowncastClone() {
      if (this is _ICartItem dt) { return dt; }
      return new CartItem(_item, _quantity, _price);
    }
    public override bool Equals(object other) {
      var oth = other as CartItem;
      return oth != null && object.Equals(this._item, oth._item) && this._quantity == oth._quantity && this._price == oth._price;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._item));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._quantity));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._price));
      return (int) hash;
    }
    public override string ToString() {
      string s = "CartItem.CartItem";
      s += "(";
      s += Dafny.Helpers.ToString(this._item);
      s += ", ";
      s += Dafny.Helpers.ToString(this._quantity);
      s += ", ";
      s += Dafny.Helpers.ToString(this._price);
      s += ")";
      return s;
    }
    private static readonly _ICartItem theDefault = create(ItemId.Default(), Quantity.Default(), Dafny.BigRational.ZERO);
    public static _ICartItem Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_ICartItem> _TYPE = new Dafny.TypeDescriptor<_ICartItem>(CartItem.Default());
    public static Dafny.TypeDescriptor<_ICartItem> _TypeDescriptor() {
      return _TYPE;
    }
    public static _ICartItem create(_IItemId item, BigInteger quantity, Dafny.BigRational price) {
      return new CartItem(item, quantity, price);
    }
    public static _ICartItem create_CartItem(_IItemId item, BigInteger quantity, Dafny.BigRational price) {
      return create(item, quantity, price);
    }
    public bool is_CartItem { get { return true; } }
    public _IItemId dtor_item {
      get {
        return this._item;
      }
    }
    public BigInteger dtor_quantity {
      get {
        return this._quantity;
      }
    }
    public Dafny.BigRational dtor_price {
      get {
        return this._price;
      }
    }
